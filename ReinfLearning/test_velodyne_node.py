...
def check_pos(x, y):
    ...
    if x > -0.58 and 1.6 > y > -1.6 and ((x-4.5)**2+(y-0.36)**2)>r: #**********************TO AVOID FIRST CYLINDER OBSTACLE
        goal_ok = True
...
if __name__ == '__main__':
    ...
    try:
        ...
        #network.load(file_name, "/home/a/deep-rl-navigation/DRL_robot_navigation_ros2/results/pytorch_models")
    except:
